#run in admin cmd prompt streamlit run streamlit run C:\Users\Shyryyuu\Downloads\soundtetection\app.py
...
gmm_male = pickle.load(open(r'C:\Users\Shyryyuu\Downloads\soundtetection\male.gmm','rb'))
gmm_female = pickle.load(open(r'C:\Users\Shyryyuu\Downloads\soundtetection\female.gmm','rb'))
